...
<!-- REPOS:START -->
- [dotnet-claude-starter-kit](https://github.com/cwoodruff/dotnet-claude-starter-kit) — ★ 2 — <sub>Sep 14, 2026</sub>
- [rust-api-modular-monolithic](https://github.com/cwoodruff/rust-api-modular-monolithic) — <sub>Sep 14, 2026</sub>
...
<sub>This README updates itself daily via [GitHub Actions](.github/workflows/update-profile.yml) — last updated: <!-- STAMP:START -->Sep 15, 2026 11:24 UTC<!-- STAMP:END --></sub>
