...
<!-- REPOS:START -->
- [book-network-programming-csharp](https://github.com/cwoodruff/book-network-programming-csharp) — ★ 62 — <sub>Aug 23, 2026</sub>
- [aspnet-alpinejs](https://github.com/cwoodruff/aspnet-alpinejs) — A sample project to see how well AlpineJS web components work with ASP.NET Razor Pages · ★ 2 — <sub>Aug 22, 2026</sub>
...
<sub>This README updates itself daily via [GitHub Actions](.github/workflows/update-profile.yml) — last updated: <!-- STAMP:START -->Aug 23, 2026 11:24 UTC<!-- STAMP:END --></sub>
