...
<!-- REPOS:START -->
- [book-network-programming-csharp](https://github.com/cwoodruff/book-network-programming-csharp) — ★ 64 — <sub>Aug 23, 2026</sub>
...
<sub>This README updates itself daily via [GitHub Actions](.github/workflows/update-profile.yml) — last updated: <!-- STAMP:START -->Aug 26, 2026 11:25 UTC<!-- STAMP:END --></sub>
